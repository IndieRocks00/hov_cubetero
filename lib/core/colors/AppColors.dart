...
class AppColors {
  ...
  static const Color backgroundLoadingScreen = Color(0xCF070707);
...
// Añade más colores según lo necesites
  ...
  static const Color alert_information = Colors.grey;
  static const Color textColorInformation = Colors.black;

  static const Color alert_ok = Colors.green;
  ...
  static const Color textCardProdcutSelect = Color(0xffffffff);
  static const Color backgCardProdNOSelect = Color(0xffc9c9c9);
  static const Color textCardProdcutNOSelect = Color(0xff000000);


  static const Color backgroundTextField = Color(0xffc2bfbf);
