...
class Payment extends StatefulWidget {
  ...
  Payment({Key? key,required this.codigo, required this.codigoV, required this.codigoP,required this.monto, required this.propina, required this.inventario, required this.modePayment, required this.banco, required this.referencia}) : super(key: key);

  @override
  State<Payment> createState() => _PaymentState(codigo, codigoV, codigoP, monto, propina, inventario, modePayment, banco, referencia);
}
...
class _PaymentState extends State<Payment> {
  ...
  _PaymentState(this._codigo, this._codigoV, this._codigoP, this._monto, this._propina, this._inventario, this.modePayment, this._banco, this._referencia);
